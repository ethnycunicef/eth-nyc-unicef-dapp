...
contract ChainLinkData is ChainlinkClient, Ownable {
  ...
  function requestEtherscan(address _oracle, string _jobId)
    public
    onlyOwner
  {
    Chainlink.Request memory req = buildChainlinkRequest(stringToBytes32(_jobId), this, this.fulfillEthereumPrice.selector);
    req.add("url", "https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0x9663543c5Fa87C0502149A9fa186dC24738AC84C&address=0x627306090abaB3A6e1400e9345bC60c78a8BEf57&tag=latest&apikey=2V6IFWWRRQANUUQDT5ZCKGJX3PHF6MHURV
");
    req.add("url", "");
   // req.add("path", "USD");
